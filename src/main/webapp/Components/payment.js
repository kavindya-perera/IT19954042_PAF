...
$(document).on("click", "#btnSave", function(event) {
	...
	// If valid------------------------  
	var type = ($("#hidPaymentIDUpdate").val() == "") ? "POST" : "PUT";
